"pt": {
  "choosecurrency": "Escolha a moeda",
    ...
    "securitystep0": "O primeiro passo é <strong>baixar</strong> esse website do <a href=\"https://github.com/RapidsOfficial/Paper-Wallet\">Github</a> e abrir o arquivo index.html diretamente de seu computador. É simplesmente muito fácil de esconder algum código malicioso em mais de 6000 linhas de JavaScript para vazar sua chave privada, e você não quer ver seus fundos serem roubados. O controle de versão de código torna muito mais fácil verificar de forma intercalada o que realmente executa. Para segurança extra, <strong>desconecte seu acesso a internet</strong> enquanto gerando sua carteira.",
    ...
    "footersupport": "Apoie Rapids Network",
