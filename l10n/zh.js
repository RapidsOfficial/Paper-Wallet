"zh": {
  "choosecurrency": "選擇幣別",
    ...
    "securitystep0": "請先自<a href=\"https://github.com/RapidsOfficial/Paper-Wallet\">Github</a>處<strong>下載</strong>這個網站，接著直接在您的電腦開啟index.html檔案。為了提高安全性，在生成錢包地址時，請<strong>斷開網路連結</strong>(例如拔除網路線或關閉wifi)。駭客很輕易能在6000多行javascript中找到你的私鑰，透過原始碼版本控制。可以交叉確認是否運行順利。",
    ...
    "footersupport": "贊助 Rapids Network",
